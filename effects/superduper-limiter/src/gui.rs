    ...
    egui::CentralPanel::default().show(ctx, |ui| {
        ...
        egui::ScrollArea::vertical().show(ui, |ui| {
            core_gui::section(ui, "Levels", |ui| {
                core_gui::dirty_param_row_g(ui, &state.shared.params[P_INPUT], &PARAMS[P_INPUT], &state.shared.dirty_params[P_INPUT], core_gui::GestureBridge { begin: &state.shared.gesture_begin, end: &state.shared.gesture_end }, P_INPUT);
