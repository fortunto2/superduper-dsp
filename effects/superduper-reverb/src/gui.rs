    ...
    egui::CentralPanel::default().show(ctx, |ui| {
        ...
        egui::ScrollArea::vertical().show(ui, |ui| {
            core_gui::section(ui, "Space", |ui| {
                core_gui::param_row(ui, &state.shared.params[P_SIZE], &PARAMS[P_SIZE]);
                core_gui::param_row(ui, &state.shared.params[P_DECAY], &PARAMS[P_DECAY]);
                core_gui::param_row(ui, &state.shared.params[P_DAMP], &PARAMS[P_DAMP]);
                core_gui::param_row(ui, &state.shared.params[P_PREDELAY], &PARAMS[P_PREDELAY]);
                core_gui::param_row(ui, &state.shared.params[P_MOD], &PARAMS[P_MOD]);
            });
