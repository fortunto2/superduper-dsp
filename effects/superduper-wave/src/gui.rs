    ...
    egui::CentralPanel::default().show(ctx, |ui| {
        ...
        egui::ScrollArea::vertical().show(ui, |ui| {
            core_gui::section(ui, "Oscillator", |ui| {
                core_gui::learn_param_row_g(ui, &state.shared.params[P_WT_POS], &PARAMS[P_WT_POS], &state.shared.dirty_params[P_WT_POS], &state.shared.midi_learn, P_WT_POS, core_gui::GestureBridge { begin: &state.shared.gesture_begin, end: &state.shared.gesture_end });
            ...
            core_gui::section(ui, "Filter Envelope", |ui| {
                core_gui::learn_param_row_g(ui, &state.shared.params[P_FENV_AMOUNT], &PARAMS[P_FENV_AMOUNT], &state.shared.dirty_params[P_FENV_AMOUNT], &state.shared.midi_learn, P_FENV_AMOUNT, core_gui::GestureBridge { begin: &state.shared.gesture_begin, end: &state.shared.gesture_end });
                core_gui::learn_param_row_g(ui, &state.shared.params[P_FENV_A], &PARAMS[P_FENV_A], &state.shared.dirty_params[P_FENV_A], &state.shared.midi_learn, P_FENV_A, core_gui::GestureBridge { begin: &state.shared.gesture_begin, end: &state.shared.gesture_end });
                core_gui::learn_param_row_g(ui, &state.shared.params[P_FENV_D], &PARAMS[P_FENV_D], &state.shared.dirty_params[P_FENV_D], &state.shared.midi_learn, P_FENV_D, core_gui::GestureBridge { begin: &state.shared.gesture_begin, end: &state.shared.gesture_end });
                core_gui::learn_param_row_g(ui, &state.shared.params[P_FENV_S], &PARAMS[P_FENV_S], &state.shared.dirty_params[P_FENV_S], &state.shared.midi_learn, P_FENV_S, core_gui::GestureBridge { begin: &state.shared.gesture_begin, end: &state.shared.gesture_end });
                core_gui::learn_param_row_g(ui, &state.shared.params[P_FENV_R], &PARAMS[P_FENV_R], &state.shared.dirty_params[P_FENV_R], &state.shared.midi_learn, P_FENV_R, core_gui::GestureBridge { begin: &state.shared.gesture_begin, end: &state.shared.gesture_end });
            });
            core_gui::section(ui, "LFO 1", |ui| {
                ...
                core_gui::learn_param_row_g(ui, &state.shared.params[P_LFO_SHAPE], &PARAMS[P_LFO_SHAPE], &state.shared.dirty_params[P_LFO_SHAPE], &state.shared.midi_learn, P_LFO_SHAPE, core_gui::GestureBridge { begin: &state.shared.gesture_begin, end: &state.shared.gesture_end });
                core_gui::learn_param_row_g(ui, &state.shared.params[P_LFO_DEST], &PARAMS[P_LFO_DEST], &state.shared.dirty_params[P_LFO_DEST], &state.shared.midi_learn, P_LFO_DEST, core_gui::GestureBridge { begin: &state.shared.gesture_begin, end: &state.shared.gesture_end });
                core_gui::learn_param_row_g(ui, &state.shared.params[P_LFO_RATE], &PARAMS[P_LFO_RATE], &state.shared.dirty_params[P_LFO_RATE], &state.shared.midi_learn, P_LFO_RATE, core_gui::GestureBridge { begin: &state.shared.gesture_begin, end: &state.shared.gesture_end });
                core_gui::learn_param_row_g(ui, &state.shared.params[P_LFO_DEPTH], &PARAMS[P_LFO_DEPTH], &state.shared.dirty_params[P_LFO_DEPTH], &state.shared.midi_learn, P_LFO_DEPTH, core_gui::GestureBridge { begin: &state.shared.gesture_begin, end: &state.shared.gesture_end });
